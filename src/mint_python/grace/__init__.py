# FILE: src/mint_python/grace/__init__.py
# VERSION: 1.0.0
...
#
# START_MODULE_MAP
#   GRACE_NS - namespace urn:mint:grace:2026:manifest
...
#   LAST_CHANGE: Wave-11-1 — initial MP-GRACE implementation, adapted from M-GRACE
#     (src/mint/grace/__init__.py) for pure Python stdlib-only deps
# END_CHANGE_SUMMARY
...
def bootstrap(
    ...
    logger.info(
        "[MP-Grace][inject][BLOCK_INJECT_MANIFEST] "
...
def _inject_custom_xml_part(
    ...
    logger.info(
        "[MP-Grace][preserve][BLOCK_PRESERVE_EXISTING] "
